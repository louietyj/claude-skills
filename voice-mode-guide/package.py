...
Bundles no credentials. It does depend on session-init being installed
alongside it, and reports that rather than failing if it isn't.
"""
...
MEMBERS = ["SKILL.md", "voice-mode-guide.sh", "voice-brief.md", "skill-index.py"]
...
def main() -> int:
    ...
    print(f"Wrote {out}")
    print("Requires session-init to be installed too; it boots the conversation.")
    return 0
